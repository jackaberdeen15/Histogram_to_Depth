...
HD_PWD='C:/Users/u39jm15/Documents/Vivado_Projects/Histogram_to_Depth/Histogram_to_Depth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Histogram_to_Depth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Histogram_to_Depth.tcl
